...
public class AddAccountant extends JFrame implements ActionListener {
    ...
    AddAccountant(){
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("FeeReportManagement/icons/img3.png"));
        Image img3=img.getImage().getScaledInstance(100, 100,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==bt1){
            ...
            try
            {
                ...
                String q="insert into accountant(name, password, email, contact, address) value ('"+name+"','"+pass+"','"+email+"','"+cont+"','"+add+"')";
