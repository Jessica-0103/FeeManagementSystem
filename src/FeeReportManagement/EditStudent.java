        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if(e.getSource()==bt1){
                try{
                    ...
                    var q3="update add_student set name='"+name+"',email='"+email+"',course='"+course+"',fee='"+fee+"',paid='"+paid+"',due='"+due+"',address='"+add+"',city='"+city+"',state='"+state+"',country='"+country+"',contact='"+cont+"' where rollno='"+roll+"' ";
                    int aa=obj2.stm.executeUpdate(q3);
                    if(aa==1){
